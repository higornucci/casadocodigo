...
import br.com.casadocodigo.config.SecurityConfiguration;
...
@ContextConfiguration(classes = {JpaConfiguration.class, WebAppConfiguration.class, SecurityConfiguration.class, DataSourceConfigurationTest.class})
@ActiveProfiles("test")
